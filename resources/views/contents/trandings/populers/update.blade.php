                ...
                <form role="form" class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ url('trandings/populers/update/'.$populers->idpopulers) }}">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name</label>
                        <div class="col-sm-5">
                            <input type="text" name="name" value="{{$populers->name}}" class="form-control" required>
                        </div>
                    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title" id="exampleModalLabel">Delete Populers</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        Are You Sure Delete Populers ?
      </div>
      <div class="modal-footer">
          <form action="{{ url('trandings/populers/delete/'.$populers->idpopulers) }}" role="form" method="post">
            @method('delete')
            @csrf
